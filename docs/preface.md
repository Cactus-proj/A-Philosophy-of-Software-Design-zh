...
> 人们为电子计算机编写程序已有 80 多年的历史了，但是，关于如何设计这些程序或好的程序应该是什么样的讨论却很少，令人惊讶。关于诸如敏捷开发之类的软件开发过程以及诸如调试器，版本控制系统和测试覆盖率工具之类的开发工具已经进行了大量讨论。还已经对诸如面向对象编程和功能编程之类的编程技术以及设计模式和算法进行了广泛的分析。所有这些讨论都是有价值的，但软件设计的核心问题仍未解决。David Parnas 的经典论文“关于将系统分解为模块的标准”发表于 1971 年，
